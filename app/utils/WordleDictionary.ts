...
export const wordleDictionary: Word[] = [
    "abide", "abort", "about", "above", "abuse",
    "abyss", 'actor', "adapt", 'adopt', 'admit', 
    'adult', 'after', 'again', 'agent', "agony", 
    'alarm', 'album', 'alive', 'alien', 'allow', 
    "alloy", 'alone', 'alter', 'agree', 'among', 
    'angel', 'anger', 'angle', 'ankle', 'annoy', 
    'angry', 'apart', 'apron', 'alpha', 'apple',
    'apply', 'arena', 'argue', 'array', 'aside',
    'asset', 'audio', 'attic', 'audit', 'award', 
    'aware', 'awful', 'avoid', 'badly', 'badge', 
    'bagel', 'baker', 'bases', 'basic', 'beach', 
    'begin', 'being', 'below', 'bench', 'billy', 
    'birth', 'blade', 'blank', 'black', 'blame', 
    'blind', 'blink', 'block', 'blood', 'bored', 
    'bloom', 'board', 'booth', 'bound', 'brain', 
    'brand', 'bread', 'break', 'brief', 'bring', 
    'broke', 'brown', 'build', 'bully', 'bunny', 
    'buyer', 'cable', 'calif', 'carry', 'catch',
    'cause', 'chain', 'chair', 'chart', 'chase',
    'cheap', 'check', 'chest', 'chess', 'chief', 
    'child', 'chill', 'china', 'chloe', 'choir', 
    'choke', 'class', 'chord', 'chuck', 'chose', 
    'civil', 'claim', 'clean', 'clear', 'click', 
    'climb', 'clock', 'close', 'cloud', 'coach',
    'coast', 'could', 'count', 'court', 'cover', 
    'crack', 'crash', 'crawl', 'craft', 'cream', 
    'crime', 'cross', 'crown', 'crust', 'curve',
    'daily', 'dance', 'dated', 'dealt', 'death',
    'delay', 'depth', 'doubt', 'dozen', 'draft',
    'drain', 'drama', 'drawn', 'dream', 'dress',
    'drink', 'drive', 'drove', 'eager', 'early', 
    'eaten', 'elect', 'earth', 'eight', 'elite', 
    'empty', 'enemy', 'enjoy', 'enter', 'entry', 
    'equal', 'error', 'event', 'every', 'exact', 
    'exist', 'extra', 'faith', 'fancy', 'fence',
    ...
    'maker', 'maple', 'march', 'maria', 'march', 
    'marry', 'match', 'maybe', 'maxim', 'mayor', 
    'meant', 'media', 'merge', 'metal', 'might',
    ...
    'pilot', 'pinky', 'pitch', 'place', 'plain', 
    'plane', 'plant', 'plate', 'polar', 'point', 
    'pound', 'power', 'press', 'price', 'pride', 
    'prime', 'print', 'prior', 'prize', 'proof', 
    'proud', 'prove', 'queen', 'quick', 'quiet', 
    'quite', 'radio', 'raise', 'range', 'rapid', 
    'ratio', 'reach', 'ready', 'refer', 'relay',
    'reply', 'reset', 'rhyme', 'rider', 'rifle',
    ...
    'stage', 'stand', 'stark', 'stake', 'start', 
    'state', 'steam', 'steel', 'stick', 'still', 
    'stock', 'stone', 'stood', 'stool',
